...
router.post("/add-doctor", verifyLogin, (req, res) => {
  ...
  var sub = "Added to Doctor's List on Doc-Talk";
  var output = `
  <h3>Hi, ${req.body.name}</h3>
  <h3>Greetings from Doc-Talk</h3>

  <p>Admin Of Doc-Talk added you to our doctor's list.
...
router.post("/add-patient", verifyLogin, (req, res) => {
  ...
  var to = req.body.email;
  var sub = "Added to Patient's List on Doc-Talk";
  if (req.body.email) {
  ...
  adminHelpers
    ...
    .then((response) => {
      if (req.body.email) {
        var output = `
      <h3>Hi, ${req.body.name}
      Greetings from Doc-Talk</h3>

      <p>Admin Of Doc-Talk added you to our patient's list .
    ...
    `;
        ...
        var output = `
        Hi, ${req.body.name}
        Greetings from Doc-Talk
      
        Admin Of Doc-Talk added you to our patient's list .
